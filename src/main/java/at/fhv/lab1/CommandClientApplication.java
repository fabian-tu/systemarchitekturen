...
public class CommandClientApplication {
    ...
    public CommandLineRunner run() throws Exception {
        return args -> {
            ...
            Booking[] bookings = {
                    new Booking(customers[0].getCustomerId(), rooms[0].getRoomId(), LocalDate.of(2024, 9, 15), LocalDate.of(2024, 9, 20)),
                    new Booking(customers[1].getCustomerId(), rooms[1].getRoomId(), LocalDate.of(2024, 5, 18), LocalDate.of(2024, 5, 22)),
                    new Booking(customers[2].getCustomerId(), rooms[2].getRoomId(), LocalDate.of(2024, 2, 5), LocalDate.of(2024, 2, 12)),
                    new Booking(customers[3].getCustomerId(), rooms[3].getRoomId(), LocalDate.of(2024, 4, 22), LocalDate.of(2024, 4, 23)),
                    new Booking(customers[4].getCustomerId(), rooms[4].getRoomId(), LocalDate.of(2024, 8, 24), LocalDate.of(2024, 9, 1)),
                    new Booking(customers[5].getCustomerId(), rooms[5].getRoomId(), LocalDate.of(2024, 7, 30), LocalDate.of(2024, 8, 12)),
                    new Booking(customers[6].getCustomerId(), rooms[6].getRoomId(), LocalDate.of(2024, 3, 28), LocalDate.of(2024, 4, 5)),
                    new Booking(customers[7].getCustomerId(), rooms[7].getRoomId(), LocalDate.of(2024, 12, 12), LocalDate.of(2024, 12, 17)),
                    new Booking(customers[8].getCustomerId(), rooms[8].getRoomId(), LocalDate.of(2024, 5, 2), LocalDate.of(2024, 5, 9)),
                    new Booking(customers[9].getCustomerId(), rooms[9].getRoomId(), LocalDate.of(2024, 1, 4), LocalDate.of(2024, 1, 15))
            };
